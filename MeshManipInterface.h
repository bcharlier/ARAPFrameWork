...
class MMInterface
{
    ...
    vector< point_t > modified_vertices;

    // MESH MANIP :
    vector< bool > selected_vertices;
    vector< bool > fixed_vertices;


    // MESH VISU :
    vector< vector< int > > visu_triangles;
    vector< vector< int > > visu_quads;
...
public:
    ...
    inline vector< point_t > & get_vertices() { return vertices ; }
    inline vector< point_t > const & get_vertices() const { return vertices ; }
    inline int get_vertices_nb() { return vertices.size() ; }

    inline vector< vector< int > > & get_triangles() { return triangles ; }
    inline vector< vector< int > > const & get_triangles() const { return triangles ; }


    inline vector< vector< int > > & get_visu_triangles() { return visu_triangles ; }
    inline vector< vector< int > > const & get_visu_triangles() const { return visu_triangles ; }
    
    inline vector< vector< int > > & get_visu_quads() { return visu_quads ; }
    inline vector< vector< int > > const & get_visu_quads() const { return visu_quads ; }
    
    // ACCESS the output :
    inline vector< point_t > const & get_modified_vertices() const { return modified_vertices ; }
    
    inline vector< bool > & get_selected_vertices () { return selected_vertices; }
    inline const vector< bool > & get_selected_vertices () const { return selected_vertices; }
